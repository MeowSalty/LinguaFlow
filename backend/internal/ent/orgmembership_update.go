...
func (_u *OrgMembershipUpdate) SetRole(v string) *OrgMembershipUpdate {
	_u.mutation.SetRole(v)
	return _u
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_u *OrgMembershipUpdate) SetNillableRole(v *string) *OrgMembershipUpdate {
	if v != nil {
		_u.SetRole(*v)
	}
	return _u
...
func (_u *OrgMembershipUpdate) SetOrganizationID(id int) *OrgMembershipUpdate {
...
func (_u *OrgMembershipUpdate) SetUserID(id int) *OrgMembershipUpdate {
...
func (_u *OrgMembershipUpdate) defaults() {
...
func (_u *OrgMembershipUpdate) check() error {
	...
	if _u.mutation.UserCleared() && len(_u.mutation.UserIDs()) > 0 {
		return errors.New(`ent: clearing a required unique edge "OrgMembership.user"`)
	}
	return nil
}
...
func (_u *OrgMembershipUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(orgmembership.Table, orgmembership.Columns, sqlgraph.NewFieldSpec(orgmembership.FieldID, field.TypeInt))
...
// SetRole sets the "role" field.
func (_u *OrgMembershipUpdateOne) SetRole(v string) *OrgMembershipUpdateOne {
	_u.mutation.SetRole(v)
	return _u
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_u *OrgMembershipUpdateOne) SetNillableRole(v *string) *OrgMembershipUpdateOne {
	if v != nil {
		_u.SetRole(*v)
	}
	return _u
...
// SetOrganizationID sets the "organization" edge to the Organization entity by ID.
func (_u *OrgMembershipUpdateOne) SetOrganizationID(id int) *OrgMembershipUpdateOne {
	_u.mutation.SetOrganizationID(id)
	return _u
}
...
// SetUserID sets the "user" edge to the User entity by ID.
func (_u *OrgMembershipUpdateOne) SetUserID(id int) *OrgMembershipUpdateOne {
	_u.mutation.SetUserID(id)
	return _u
}
...
// defaults sets the default values of the builder before save.
func (_u *OrgMembershipUpdateOne) defaults() {
	if _, ok := _u.mutation.UpdatedAt(); !ok {
		v := orgmembership.UpdateDefaultUpdatedAt()
		_u.mutation.SetUpdatedAt(v)
	}
