...
const (
	// Label holds the string label denoting the pruneprompttemplate type in the database.
	Label = "prune_prompt_template"
	...
	// Table holds the table name of the pruneprompttemplate in the database.
	Table = "prune_prompt_templates"
	// OwnerUserTable is the table that holds the owner_user relation/edge.
	OwnerUserTable = "prune_prompt_templates"
	...
	OwnerOrgTable = "prune_prompt_templates"
...
// Columns holds all SQL columns for pruneprompttemplate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the PrunePromptTemplate queries.
