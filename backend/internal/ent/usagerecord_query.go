...
func (_q *UsageRecordQuery) QueryUser() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(usagerecord.Table, usagerecord.FieldID, selector),
...
func (_q *UsageRecordQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *UsageRecordQuery) QueryProject() *ProjectQuery {
...
func (_q *UsageRecordQuery) QueryJob() *JobQuery {
...
func (_q *UsageRecordQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UsageRecordQuery) FirstIDX(ctx context.Context) int {
...
func (_q *UsageRecordQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *UsageRecordQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *UsageRecordQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *UsageRecordQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *UsageRecordQuery) WithUser(opts ...func(*UserQuery)) *UsageRecordQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *UsageRecordQuery) WithOrganization(opts ...func(*OrganizationQuery)) *UsageRecordQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UsageRecordQuery) WithProject(opts ...func(*ProjectQuery)) *UsageRecordQuery {
	query := (&ProjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *UsageRecordQuery) WithJob(opts ...func(*JobQuery)) *UsageRecordQuery {
	query := (&JobClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(usagerecord.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.UsageRecord.Query().
//		Select(usagerecord.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *UsageRecordQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*UsageRecord, error) {
	...
	if _q.withUser != nil || _q.withOrganization != nil || _q.withProject != nil || _q.withJob != nil {
		withFKs = true
	}
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, usagerecord.ForeignKeys...)
	}
...
func (_q *UsageRecordQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*UsageRecord, init func(*UsageRecord), assign func(*UsageRecord, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*UsageRecord)
	for i := range nodes {
		if nodes[i].user_usage_records == nil {
			continue
		}
		fk := *nodes[i].user_usage_records
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "user_usage_records" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *UsageRecordQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*UsageRecord, init func(*UsageRecord), assign func(*UsageRecord, *Organization)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*UsageRecord)
	for i := range nodes {
		if nodes[i].organization_usage_records == nil {
			continue
		}
		fk := *nodes[i].organization_usage_records
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "organization_usage_records" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *UsageRecordQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*UsageRecord, init func(*UsageRecord), assign func(*UsageRecord, *Project)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*UsageRecord)
	for i := range nodes {
		if nodes[i].project_usage_records == nil {
			continue
		}
		fk := *nodes[i].project_usage_records
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "project_usage_records" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *UsageRecordQuery) loadJob(ctx context.Context, query *JobQuery, nodes []*UsageRecord, init func(*UsageRecord), assign func(*UsageRecord, *Job)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*UsageRecord)
	for i := range nodes {
		if nodes[i].job_usage_records == nil {
			continue
		}
		fk := *nodes[i].job_usage_records
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "job_usage_records" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *UsageRecordQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(usagerecord.Table, usagerecord.Columns, sqlgraph.NewFieldSpec(usagerecord.FieldID, field.TypeInt))
	_spec.From = _q.sql
