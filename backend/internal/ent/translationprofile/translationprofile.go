...
const (
	// Label holds the string label denoting the translationprofile type in the database.
	...
	// Table holds the table name of the translationprofile in the database.
	Table = "translation_profiles"
	// OwnerUserTable is the table that holds the owner_user relation/edge.
	OwnerUserTable = "translation_profiles"
	...
	OwnerOrgTable = "translation_profiles"
...
// Columns holds all SQL columns for translationprofile fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
var (
	...
	DefaultConfig schema.TranslationProfileConfigData
)

// OrderOption defines the ordering options for the TranslationProfile queries.
