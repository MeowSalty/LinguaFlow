...
func (_q *ActivityLogQuery) QueryActor() *UserQuery {
...
func (_q *ActivityLogQuery) QueryOrganization() *OrganizationQuery {
...
func (_q *ActivityLogQuery) QueryProject() *ProjectQuery {
...
func (_q *ActivityLogQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ActivityLogQuery) FirstIDX(ctx context.Context) int {
...
func (_q *ActivityLogQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *ActivityLogQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *ActivityLogQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (_q *ActivityLogQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ActivityLogQuery) WithActor(opts ...func(*UserQuery)) *ActivityLogQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ActivityLogQuery) WithOrganization(opts ...func(*OrganizationQuery)) *ActivityLogQuery {
	query := (&OrganizationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ActivityLogQuery) WithProject(opts ...func(*ProjectQuery)) *ActivityLogQuery {
	query := (&ProjectClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(activitylog.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.ActivityLog.Query().
//		Select(activitylog.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (_q *ActivityLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ActivityLog, error) {
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, activitylog.ForeignKeys...)
	}
	...
	if query := _q.withActor; query != nil {
		if err := _q.loadActor(ctx, query, nodes, nil,
			func(n *ActivityLog, e *User) { n.Edges.Actor = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withOrganization; query != nil {
		if err := _q.loadOrganization(ctx, query, nodes, nil,
			func(n *ActivityLog, e *Organization) { n.Edges.Organization = e }); err != nil {
			return nil, err
		}
	}
...
func (_q *ActivityLogQuery) loadActor(ctx context.Context, query *UserQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *User)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*ActivityLog)
	for i := range nodes {
		if nodes[i].user_activity_logs == nil {
			continue
		}
		fk := *nodes[i].user_activity_logs
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "user_activity_logs" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *ActivityLogQuery) loadOrganization(ctx context.Context, query *OrganizationQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *Organization)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*ActivityLog)
	for i := range nodes {
		if nodes[i].organization_activity_logs == nil {
			continue
		}
		fk := *nodes[i].organization_activity_logs
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "organization_activity_logs" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *ActivityLogQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *Project)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*ActivityLog)
	for i := range nodes {
		if nodes[i].project_activity_logs == nil {
			continue
		}
		fk := *nodes[i].project_activity_logs
		if _, ok := nodeids[fk]; !ok {
			ids = append(ids, fk)
		}
		nodeids[fk] = append(nodeids[fk], nodes[i])
...
func (_q *ActivityLogQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(activitylog.Table, activitylog.Columns, sqlgraph.NewFieldSpec(activitylog.FieldID, field.TypeInt))
	_spec.From = _q.sql
