...
const (
	// Label holds the string label denoting the bootstrapprompttemplate type in the database.
	Label = "bootstrap_prompt_template"
	...
	// Table holds the table name of the bootstrapprompttemplate in the database.
	Table = "bootstrap_prompt_templates"
	// OwnerUserTable is the table that holds the owner_user relation/edge.
	OwnerUserTable = "bootstrap_prompt_templates"
	...
	OwnerOrgTable = "bootstrap_prompt_templates"
...
// Columns holds all SQL columns for bootstrapprompttemplate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the BootstrapPromptTemplate queries.
