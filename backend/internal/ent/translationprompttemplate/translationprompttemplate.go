...
const (
	// Label holds the string label denoting the translationprompttemplate type in the database.
	Label = "translation_prompt_template"
	...
	// Table holds the table name of the translationprompttemplate in the database.
	Table = "translation_prompt_templates"
	// OwnerUserTable is the table that holds the owner_user relation/edge.
	OwnerUserTable = "translation_prompt_templates"
	...
	OwnerOrgTable = "translation_prompt_templates"
...
// Columns holds all SQL columns for translationprompttemplate fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the TranslationPromptTemplate queries.
