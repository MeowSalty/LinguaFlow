...
const (
	// Label holds the string label denoting the executionprofile type in the database.
	...
	// Table holds the table name of the executionprofile in the database.
	Table = "execution_profiles"
	// OwnerUserTable is the table that holds the owner_user relation/edge.
	OwnerUserTable = "execution_profiles"
	...
	OwnerOrgTable = "execution_profiles"
...
// Columns holds all SQL columns for executionprofile fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
