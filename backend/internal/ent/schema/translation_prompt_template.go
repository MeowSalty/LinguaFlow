...
// TranslationPromptTemplate 翻译提示词模板实体。
type TranslationPromptTemplate struct {
	ent.Schema
}

func (TranslationPromptTemplate) Mixin() []ent.Mixin {
	return []ent.Mixin{TimeMixin{}}
}

func (TranslationPromptTemplate) Fields() []ent.Field {
	return []ent.Field{
...
func (TranslationPromptTemplate) Edges() []ent.Edge {
	return []ent.Edge{
		edge.From("owner_user", User.Type).
			Ref("translation_prompt_templates").
