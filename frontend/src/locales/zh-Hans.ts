const messages = {
  ...
  epubRotate: {
    ...
    selectNew: '换一个文件',
    stats:
      '处理内容 {content} 个、样式 {styles} 个；方向有变化 {changed} 个，原本已是目标 {already} 个；无法处理 {skipped} 个',
  ...
  quickTranslate: {
    ...
    glossaryTitle: '内联术语表',
    glossaryHint: '纯内存，翻译完即丢；项目场景下叠加在项目术语表之上',
    glossaryAdd: '添加术语',
  ...
  workspace: {
    ...
    segment: {
      ...
      translationPreview: {
        ...
        conflict: '段落内容或状态已变化，旧预览已失效。请关闭后刷新，或重新打开试译。',
    ...
    job: {
      ...
      segmentFilter: {
        ...
        skipApproved: '跳过已审核（处理除已审核外的所有段落）',
        all: '全部段落（处理所有状态的段落）',
      },
      columns: {
        id: '任务',
      ...
      form: {
        ...
        autoApproveHint: '开启后，任务完成时将自动审批通过所有段落',
        sourceLang: '源语言',
        targetLang: '目标语言',
    ...
    glossary: {
      ...
      prune: {
        title: '智能精简术语表',
        description:
          'AI 将分析当前术语表并给出删除或更新建议。预览不会修改数据，只有勾选并确认的建议才会应用。',
        backend: 'AI 后端',
  ...
  bootstrapPromptTemplates: {
    ...
    messages: {
      createSuccess: '术语抽取模板创建成功',
      createFailed: '术语抽取模板创建失败',
      updateSuccess: '术语抽取模板已更新',
      updateFailed: '术语抽取模板更新失败',
      deleteSuccess: '术语抽取模板已删除',
      deleteFailed: '术语抽取模板删除失败',
      systemDeleteForbidden: '系统模板不可删除',
    },
    empty: {
      default: '暂无术语抽取模板，创建一个模板来定义术语抽取指令。',
      filtered: '没有找到符合条件的模板。',
    },
    delete: {
      confirm: '确定要删除术语抽取模板「{name}」吗？此操作无法撤销。',
    },
  },
  prunePromptTemplates: {
    ...
    messages: {
      createSuccess: '术语精简模板创建成功',
      updateSuccess: '术语精简模板已更新',
      deleteSuccess: '术语精简模板已删除',
      systemDeleteForbidden: '系统模板不可删除',
    },
    empty: {
      default: '暂无术语精简模板。内置默认模板仍可直接用于分析。',
      filtered: '没有找到符合条件的模板。',
    },
    delete: {
      confirm: '确定要删除术语精简模板「{name}」吗？此操作无法撤销。',
    },
  },
  executionProfiles: {
  ...
  executionPlanEditor: {
    ...
    round: {
      ...
      segmentFilterSkipApproved: '跳过已审核',
      ...
      adjudicatePromptHint: '裁决 system prompt 内置不可见，无需选择提示词模板。',
      adjudicateBatchSize: '段落数上限',
      adjudicateBatchSizeHint: '0=不限制，与字词数上限至少填一项',
      ...
      revisePromptHint:
        '修订 system prompt 内置不可见，无需选择提示词模板；LLM 对现有译文做最小改动定点修订，仅修复未决（pending）的语义问题，写回不改段落状态。',
      ...
      reviseBatchSizeHint: '0=不限制，与字词数上限至少填一项',
      reviseMaxWordsPerBatch: '字词数上限',
      reviseMaxWordsPerBatchHint: '0=不限制，与段落数上限至少填一项',
      correctPromptHint:
  ...
  about: {
    title: '关于 LinguaFlow',
    description:
      'LinguaFlow 是一个 AI 驱动的多语言翻译工作台，帮助你将文档、字幕、电子书等内容批量翻译成多种语言。支持术语管理、翻译审核、进度追踪，让翻译工作更高效、更准确。',
    ...
    featureReview: '翻译审核',
    featureReviewDesc: '按状态筛选，行内编辑译文，批量通过/拒绝，添加备注。',
    featureConfig: '灵活配置',
  ...
  admin: {
    ...
    auditLogs: {
      ...
      actions: {
        ...
        segmentApproveAll: '全部通过',
        segmentRetranslateRejected: '重译被拒段落',
        glossarySync: '术语同步',
        quickTranslate: '即时翻译',
