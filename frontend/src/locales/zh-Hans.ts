const messages = {
  ...
  templates: {
    ...
    form: {
      name: '模板名称',
      namePlaceholder: '例如：技术文档翻译',
      description: '模板描述',
      descriptionPlaceholder: '简要说明模板的用途和适用场景',
      icon: '图标',
      iconPlaceholder: '选择或输入 emoji',
      systemPrompt: '系统提示词',
      systemPromptPlaceholder: '自定义翻译的系统提示词，留空使用默认',
      promptVars: '提示词变量',
      promptVarsKeyPlaceholder: '变量名',
      promptVarsValuePlaceholder: '变量值',
      translationConfig: '翻译配置',
      translationConfigKeyPlaceholder: '配置键',
      translationConfigValuePlaceholder: '配置值',
      addVar: '添加变量',
      addConfig: '添加配置',
      insertBuiltinVar: '系统变量：',
      insertUserVar: '自定义变量：',
    },
    validation: {
    ...
    messages: {
      ...
      deleteSuccess: '模板已删除',
      deleteFailed: '模板删除失败',
      builtinDeleteForbidden: '内置模板不可删除',
    },
    empty: {
      default: '暂无模板，创建一个模板来标准化翻译流程。',
      filtered: '没有找到符合条件的模板。',
    },
    delete: {
      confirm: '确定要删除模板「{name}」吗？此操作无法撤销。',
    },
  },
  about: {
    title: '关于 LinguaFlow',
