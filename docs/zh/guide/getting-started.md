...
若作业失败，先看作业错误信息，并对照 [常见问题](/zh/guide/faq) 中的 API Key、限速与网络项。
:::

可选：在资源页 **下载** 翻译结果文件，确认导出内容符合预期。
...
| 多轮计划、质量裁决、保护规则       | [翻译配置](/zh/guide/translation-config) · [高级功能](/zh/guide/advanced) |
